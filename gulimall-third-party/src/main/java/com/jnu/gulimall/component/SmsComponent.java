package com.jnu.gulimall.component;
...
public class SmsComponent {
    ...
    public boolean sendCode(String phone, String code) {
        try {
            ...
            String sdkAppId = "1400738651";
            req.setSmsSdkAppId(sdkAppId);

            /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名 */
            // 签名信息可前往 [国内短信](https://console.cloud.tencent.com/smsv2/csms-sign) 或 [国际/港澳台短信](https://console.cloud.tencent.com/smsv2/isms-sign) 的签名管理查看
            String signName = "编程学习个人网";
            req.setSignName(signName);

            /* 模板 ID: 必须填写已审核通过的模板 ID */
            // 模板 ID 可前往 [国内短信](https://console.cloud.tencent.com/smsv2/csms-template) 或 [国际/港澳台短信](https://console.cloud.tencent.com/smsv2/isms-template) 的正文模板管理查看
            String templateId = "1545689";
...
//            req.setSenderId(senderid);
            ...
            SendStatus[] statusSet = res.getSendStatusSet();
//            return "Ok".equals(statusSet[0].getCode()) && "send success".equals(statusSet[0].getMessage());
            return true;
